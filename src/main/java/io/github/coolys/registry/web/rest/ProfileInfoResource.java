package io.github.coolys.registry.web.rest;
...
public class ProfileInfoResource {
    ...
    public ProfileInfoResource(Environment env, CoolybotProperties jHipsterProperties, ConfigServerConfig configServerConfig) {
        this.env = env;

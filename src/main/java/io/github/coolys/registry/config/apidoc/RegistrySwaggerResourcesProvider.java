package io.github.coolys.registry.config.apidoc;
...
@Component
@Primary
@Profile(CoolybotConstants.SPRING_PROFILE_SWAGGER)
public class RegistrySwaggerResourcesProvider implements SwaggerResourcesProvider {
    ...
    public List<SwaggerResource> get() {
        ...
        //Add the registry swagger resource that correspond to the coolybot-registry's own swagger doc
        resources.add(swaggerResource("coolybot-registry", "/v2/api-docs"));

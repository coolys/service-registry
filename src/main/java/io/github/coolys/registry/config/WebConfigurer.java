...
public class WebConfigurer implements ServletContextInitializer, WebServerFactoryCustomizer {
    ...
    public WebConfigurer(Environment env, CoolybotProperties jHipsterProperties) {
        this.env = env;
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        if (env.acceptsProfiles(CoolybotConstants.SPRING_PROFILE_PRODUCTION)) {
    ...
    public void customize(WebServerFactory server) {
         ...
         * See the CoolybotProperties class and your application-*.yml configuration files
         * for more information.
         */
        if (jHipsterProperties.getHttp().getVersion().equals(CoolybotProperties.Http.Version.V_2_0) &&
    ...
    private void setMimeMappings(WebServerFactory server) {
        if (server instanceof UndertowServletWebServerFactory) {
            ...
            // IE issue, see https://github.com/coolybot/generator-coolybot/pull/711

package io.github.coolys.registry.security.oauth2;
...
public class OAuth2ClientCredentialsService {
    ...
    public OAuth2ClientCredentialsService(RestTemplate restTemplate, CoolybotProperties jHipsterProperties) {

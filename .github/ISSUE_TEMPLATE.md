...
- If you have a support request rather than a bug, please use [Stack Overflow](http://stackoverflow.com/questions/tagged/coolybot) with the Coolybot tag.
- For bug reports it is mandatory to run the command `coolybot info` in your project's root folder, and paste the result here.
...
##### **Coolybot Registry Version(s)**

<!--
Which version of Coolybot Registry are you using, is it a regression?
-->
